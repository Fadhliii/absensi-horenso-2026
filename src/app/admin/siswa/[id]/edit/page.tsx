...
export default function EditSiswaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const [res, perusahaanRes] = await Promise.all([
          getSiswaByIdAction(id),
        ...
        if (res.error) {
          ...
          setData({
            ...
            password: '',
            perusahaan_id: res.data.perusahaan_id || '',
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2 border-t mt-6">
                <h3 className="text-md font-semibold text-gray-900 mb-4 mt-4">Data Penempatan</h3>
